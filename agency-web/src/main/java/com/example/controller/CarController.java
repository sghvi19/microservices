...
public class CarController {
    ...
    public Car createCar(@Parameter(description = "car body") @RequestBody @Valid final Car car,
                         @Parameter(description = "personalNo")@PathVariable final String personalNo) throws URISyntaxException {
        log.debug("creat car with required data:{} and personalNo:{}", car,personalNo);
